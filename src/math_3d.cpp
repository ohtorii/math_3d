...
static void usage(){
    printf(
        ...
        "  r_d          radian      -> degree\n"
        "  d_r          degree      -> radian\n"
        "  v_h          fov vertical(degree)    -> horizontal(degree)\n"
        "  h_v          fov horizontal(degree)  -> vertical(degree)\n"
        ...
        "  yxz_m33      yxz(degree) -> matrix33\n"
        "  zxy_m33      zxy(degree) -> matrix33\n"
        "  zyx_m33      zyx(degree) -> matrix33\n"
        "  yzx_m33      yzx(degree) -> matrix33\n"
        "  xzy_m33      xzy(degree) -> matrix33\n"
        "  xyz_m33      xyz(degree) -> matrix33\n"
        ...
        "  radian      0-2pi\n"
        "  quaternion  x y z w\n"
        "  axisangle   x y z w (xyz=axis w=angle)\n"
